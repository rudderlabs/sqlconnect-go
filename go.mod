...
replace cloud.google.com/go => github.com/rudderlabs/google-cloud-go v0.123.0-rudder.5

replace cloud.google.com/go/bigquery => github.com/rudderlabs/google-cloud-go/bigquery v1.77.0-rudder.1
