...
// (ARRAY<STRING>, ARRAY<INT64>, …) map to "array" so they can be targeted by
// array column filters; arrays of structs/records/maps/arrays stay "json" —
// nested element paths are out of scope (Feature 4). Returns ok=false when the
